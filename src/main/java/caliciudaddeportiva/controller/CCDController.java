...
public class CCDController {
    ...
    @CrossOrigin(origins ={"https://eventosdelvalle.com","https://eventosdelvalle.com/", "https://caliciudaddeportiva.com/","https://caliciudaddeportiva.com", "http://localhost:4200","**","*"}, methods= {RequestMethod.GET,RequestMethod.POST})
    ...
    @CrossOrigin(origins = {"https://eventosdelvalle.com","https://eventosdelvalle.com/", "https://caliciudaddeportiva.com/", "https://caliciudaddeportiva.com", "http://localhost:4200", "**", "*"},
    ...
    @CrossOrigin(origins = {"https://eventosdelvalle.com","https://eventosdelvalle.com/", "https://caliciudaddeportiva.com/", "https://caliciudaddeportiva.com", "http://localhost:4200", "**", "*"},
            methods = {RequestMethod.GET, RequestMethod.POST})
    @GetMapping("/GetHorariosDisponibles")
    public ResponseEntity<GenericDto> getHorariosDisponibles() {
        return ResponseEntity.ok().body(GenericDto.sucess(CCDService.obtenerHorariosDisponibles()));
    }

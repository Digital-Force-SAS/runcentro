...
public class CCDController {
    ...
    @CrossOrigin(origins ={"https://clustercaliciudadeportiva.org/","https://clustercaliciudadeportiva.org", "http://localhost:4200"}, methods= {RequestMethod.GET,RequestMethod.POST})
